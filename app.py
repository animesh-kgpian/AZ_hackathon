...
def load_link_of_qs():
    with open("Leetcode-Questions-Scrapper/Qdata/Qlink.txt", "r") as f:
        links = f.readlines()
...
def calculate_sorted_order_of_documents(query_terms):
    ...
    for document_index in potential_documents:
        ...
        ans.append({"Question Link": Qlink[int(document_index)-1][:-2],"Score": potential_documents[document_index]})
